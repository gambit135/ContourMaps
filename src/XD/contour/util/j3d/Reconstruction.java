 ...
 */
public class Reconstruction extends JApplet {

    int pixelMatrix[][];

    public Reconstruction(int[][] pixelMatrix) {
    ...
    public BranchGroup createSceneGraph() {
        ...
        objRotate.addChild(new Triangulacion3D(this.pixelMatrix));
    ...
    public static void main(String[] args) {
        ...
        Frame frame = new MainFrame(new Reconstruction(), 600, 400);
    } // end of main (method of MouseRotateApp)

    public static void main2(int[][] pixelMatrix) {
        Frame f = new MainFrame(new Reconstruction(pixelMatrix), 600, 400);
    }
}
