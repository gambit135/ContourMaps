 ...
 */
public class Triangulacion3DRainbow extends Shape3D {
    
    Random rand;

    public Triangulacion3DRainbow(int[][] pixelMatrix) {
    ...
    Geometry readSmfFile(String fileName, int[][] pixelMatrix) {
        ...
        //Triángulos en dos sentidos (normal e invertido
        triangles = new TriangleArray(triangulos.size() * 3 * 2 , TriangleArray.COORDINATES | TriangleArray.COLOR_3);
        int contador = 0;
        for (Triangle_d t : triangulos) {
            ...
            triangles.setColor(contador, new Color3f(rand.nextFloat(), rand.nextFloat(), rand.nextFloat()));            
            contador++;
