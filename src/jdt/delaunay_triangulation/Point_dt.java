...
public class Point_dt {
    ...
    double x, y, z;
    /**
     * The gray-scale color representation of this point, extended exclusively
     * for ContourMaps project.
     */
    int color;

    /**
     * Default Constructor. <br /> constructs a 3D point at (0,0,0).
     */
    public Point_dt() {
        this(0, 0);
    }
    ...
    public Point_dt(double x, double y, double z, int color) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.color = color;
