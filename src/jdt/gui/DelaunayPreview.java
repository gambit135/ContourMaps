...
import jdt.delaunay_triangulation.Delaunay_Triangulation;
import jdt.delaunay_triangulation.Point_dt;
import jdt.delaunay_triangulation.Triangle_dt;

/**
 * GUI class to test the delaunay_triangulation Triangulation package:
 */
public class DelaunayPreview extends Frame implements ActionListener {

    public static void main(String[] args) {
        DelaunayPreview win = new DelaunayPreview();
        win.start();
    }
    ...
    /**
     * Constructor used to summon this frame reading an input tsin file
     *
     * @param filename The tsin input file.
     */
    public DelaunayPreview(String filename) {
        this.setTitle("2D-Delaunay Triangulation - Preview");
        this.setSize(500, 500);
        _stage = 0;
        _ajd = new Delaunay_Triangulation();
        //_topoCreator = TopographicMapFactory.createTopographicMap();
        ...
        this.myOpenTsinFile(filename);
    }

    public DelaunayPreview(Delaunay_Triangulation aj) {
    ...
    public void myOpenTsinFile(String filename) {
        try {
            _ajd = new Delaunay_Triangulation(filename);
...
//					_topoCreator.createCounterLines(_ajd.trianglesIterator(), _topo_dz);
    ...
    public void myWriteSmfFile(String filename) {
        try {
            _ajd.write_smf(filename);
        }
        catch (Exception e) {
            System.out.println("ERR cant save to text file: " + filename);
            e.printStackTrace();
        }
    }
    ...
    public void paint(Graphics g) {
        ...
        if (this._view_flag == VIEW3) //			drawTopographicMap(g,_curTopoMap);
        // debug
        {
            if (_mc < _ajd.getModeCounter() && _view_flag != VORONOI) {
                _mc = _ajd.getModeCounter();
                int i = 0;
                for (Iterator<Triangle_dt> it2 = _ajd.getLastUpdatedTriangles(); it2.hasNext();) {
                    i++;
    ...
    public void Dialog() {
        /*
         * The menu bar. Commented, as the whole functionality of this is not
         * used nor required.
         *
         ...
         *
         * Menu m = new Menu("File"); MenuItem m1; m1 = new MenuItem("Open");
         * m1.addActionListener(this); m.add(m1); m1 = new MenuItem("Save
         * tsin"); m1.addActionListener(this); m.add(m1); m1 = new
         * MenuItem("Save smf"); m1.addActionListener(this); m.add(m1);
         *
         * MenuItem m6 = new MenuItem("Clear"); m6.addActionListener(this);
         * m.add(m6);
         *
         * MenuItem m2 = new MenuItem("Exit"); m2.addActionListener(this);
         * m.add(m2); mbar.add(m);
         *
         * m = new Menu("Input"); MenuItem m3 = new MenuItem("Point");
         * m3.addActionListener(this); m.add(m3); m3 = new
         * MenuItem("100-rand-ps"); m3.addActionListener(this); m.add(m3); m3 =
         * new MenuItem("Guard-30m"); m3.addActionListener(this); m.add(m3); m3
         * = new MenuItem("Client-5m"); m3.addActionListener(this); m.add(m3);
         *
         * mbar.add(m);
         *
         * m = new Menu("Functions"); MenuItem m5 = new MenuItem("Delete");
         * m5.addActionListener(this); m.add(m5); m5 = new MenuItem("Update
         * Topo"); m5.addActionListener(this); m.add(m5); mbar.add(m);
         *
         * m = new Menu("View"); m3 = new MenuItem("Lines");
         * m3.addActionListener(this); m.add(m3); m3 = new
         * MenuItem("Triangles"); m3.addActionListener(this); m.add(m3); m3 =
         * new MenuItem("Topo"); m3.addActionListener(this); m.add(m3); MenuItem
         * m4 = new MenuItem("Find"); m4.addActionListener(this); m.add(m4); m4
         * = new MenuItem("Section"); m4.addActionListener(this); m.add(m4); m4
         * = new MenuItem("Info"); m4.addActionListener(this); m.add(m4); m4 =
         * new MenuItem("CH"); m4.addActionListener(this); m.add(m4);
         * mbar.add(m); m4 = new MenuItem("Voronoi");
         * m4.addActionListener(this); m.add(m4); mbar.add(m);
         *
         * setMenuBar(mbar);
         *
         */
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (arg.equals("Open")) {
            ...
            double x0 = 10, y0 = 60, dx = this.getWidth() - x0 - 10, dy = this.getHeight()
                    - y0 - 10;
            for (int i = 0; i < 100; i++) {
...
//					_topoCreator.createCounterLines(_ajd.trianglesIterator(), _topo_dz);
     ...
     * r.contains(p) must be true! assume p.x < p .y
     *
     *
     */
